...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("output_dir", default="", help="Output directory for the result")
    parser.add_argument("name_prefix", type=str, default="", help="Name prefix for the result")
    parser.add_argument("apikey", type=str, help="NGC API Key to invoke the API function")
    parser.add_argument("function_id", type=str, default="", help="Function ID to invoke the API function")
...
async def main():
    ...
    read = asyncio.create_task(a2f.client.service.read_from_stream(stream, args.output_dir, args.name_prefix))
